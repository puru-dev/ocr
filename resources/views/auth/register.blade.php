            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="office_location" class="col-md-4 col-form-label text-md-right">{{ __('Office Location') }}</label>

                            <div class="col-md-6">
                    <input id="office_location" type="text" class="form-control @error('office_location') is-invalid @enderror" name="office_location" value="{{ old('office_location') }}" required autocomplete="office_location">
